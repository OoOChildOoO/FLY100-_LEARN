...
#define AK8963Addr 0x0C
//IIC从机地址 7位地址110100X  X由AD0端口所连接的电平所决定
...
#define MPU9250_RA_ST_X_GYRO        0x00 //生产制造期间生成的自测试值，用于检查最终用户执行的后续自测试输出。
...
//这些寄存器是用来消除直流偏置从陀螺传感器的数据输出为X, Y和Z轴。在进入传感器寄存器之前，这些寄存器中的值从陀螺传感器值中减去。
...
/*****************************************/
#define MPU9250_RA_SMPLRT_DIV       0x19//控制采样频率
#define MPU9250_RA_CONFIG           0x1A//设置陀螺仪/温度传感器的低通滤波器 
#define MPU9250_RA_GYRO_CONFIG      0x1B//配置陀螺仪量程与Fchoice
#define MPU9250_RA_ACCEL_CONFIG     0x1C//配置加速度计量程
#define MPU9250_RA_ACCEL_CONFIG_2   0x1D//配置加速度计的低通滤波器与accel_fchoice
#define MPU9250_RA_LP_ACCEL_ODR     0x1E//低功耗配置
#define MPU9250_RA_WOM_THR          0x1F//运动唤醒配置
...
#define MPU9250_RA_USER_CTRL        0x6A//控制复位与FIFO缓存使能
#define MPU9250_RA_PWR_MGMT_1       0x6B
#define MPU9250_RA_PWR_MGMT_2       0x6C//控制陀螺仪和加速度计的输出使能
